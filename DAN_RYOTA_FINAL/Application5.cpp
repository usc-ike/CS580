...
extern int no_fun(float u, float v, GzColor normal);
...
#else
        valueListShader[5] = (GzPointer)(no_fun);	/* or use ptex_fun */
#endif
		nameListShader[6] = GZ_NORMAL_MAP;
#if 0
		valueListShader[6] = (GzPointer)0;
#else
		valueListShader[6] = (GzPointer)(no_fun);
#endif
